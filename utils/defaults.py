VARIABLE_RANGES = {
    ...
    "precipitation_cosecha_sum": {
        "min": 500, "max": 1800, "default": 900, "step": 10, "unit": "mm",
...
TECHNICAL_VARIABLE_RANGES = {
    ...
    "LST_Night_1km_cosecha_mean": {
        "min": 8.0, "max": 20.0, "default": 13.0, "step": 0.1, "unit": "°C",
